...
copy temp_csv_upload (col1, col2, col3, col4, col5, col6, col7, col8, col9, col10, col11, col12) FROM 'C:/Users/Public/Documents/01-AGIP/06-2025/ARDJU008062025/ARDJU008062025.txt' DELIMITER ';' ENCODING 'UTF8';
...
and alicuota.periodo_desde <= TO_DATE('2025-06-01','yyyy-mm-dd')
and alicuota.periodo_hasta >= TO_DATE('2025-06-30','yyyy-mm-dd')
