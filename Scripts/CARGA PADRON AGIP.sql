...
copy temp_csv_upload (col1, col2, col3, col4, col5, col6, col7, col8, col9, col10, col11, col12) FROM 'C:/Users/Public/Documents/01-AGIP/03-2026/ARDJU008032026/ARDJU008032026.txt' DELIMITER ';' ENCODING 'UTF8';
