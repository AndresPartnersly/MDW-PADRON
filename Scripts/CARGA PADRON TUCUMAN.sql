...
copy tabla1 (col1, col2, col3, col4, col5, col6, col7) FROM 'C:/Users/Public/Documents/03-TUCUMAN/04-2026/padroncontribuyente_2604_300320261107/ACREDITAN.TXT' DELIMITER ';' ENCODING 'UTF8';
...
SELECT 
	...
	to_date((SUBSTRING(TRIM('20260401'), 1, 4)||'-'||SUBSTRING(TRIM('20260401'), 5, 2)||'-'||SUBSTRING(TRIM('20260401'), 7, 2)),'yyyy-mm-dd') periodo_desde,
	to_date((SUBSTRING(TRIM('20260430'), 1, 4)||'-'||SUBSTRING(TRIM('20260430'), 5, 2)||'-'||SUBSTRING(TRIM('20260430'), 7, 2)),'yyyy-mm-dd') periodo_hasta
FROM tabla1
...
CREATE TEMP TABLE tabla2 (
	...
	copy tabla2 (col1, col2, col3, col4, col5, col6, col7, col8) FROM 'C:/Users/Public/Documents/03-TUCUMAN/04-2026/coefrg116_202604_300320261107/archivocoefrg116.TXT' DELIMITER ';' ENCODING 'UTF8';
