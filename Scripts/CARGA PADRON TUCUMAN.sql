...
copy tabla1 (col1, col2, col3, col4, col5, col6, col7) FROM '/tmp/PADRONES/TUCUMAN/ACREDITAN.TXT' DELIMITER ';' ENCODING 'UTF8';
...
CREATE TEMP TABLE tabla2 (
	...
	copy tabla2 (col1, col2, col3, col4, col5, col6, col7, col8) FROM '/tmp/PADRONES/TUCUMAN/archivocoefrg116.TXT' DELIMITER ';' ENCODING 'UTF8';
