...
app.get('/search', async (req, res) => {
    ...
    console.log(`34. CUIT: ${cuit} - DESDE: ${periodo_desde} - HASTA: ${periodo_hasta} - TIPO PADRON: ${tipo} \n`);
    if (!cuit) {
    ...
    console.log(`50. CUIT: ${cuit} - DESDE: ${periodo_desde} - HASTA: ${periodo_hasta} - TIPO PADRON: ${tipo} \n`);
    try {
...
//         console.log(`75. Request Params: ${JSON.stringify(requestParameters)}`);
//         const baseUrl = requestParameters.base_url;
//         console.log(`77. Request Base URL To Get: ${baseUrl}`);
...
//                 console.log(`85. Request Response Code: ${htmlData.status}`);

//                 let docHtml = htmlData.data;
//                 console.log(`88. HTML Body: ${docHtml}`);
...
// Endpoint para obtener el documento html de una pagina web creado principalmente para servicio de actualizacion de tipo de cambio (Localizaciones ARG) con Playwright para evitar validaciones de cookies/bots
app.get('/get_html_from_url', async (req, res) => {
    ...
    try {
        ...
        const requestParameters = req.query;
        console.log(`126. Request Params: ${JSON.stringify(requestParameters)}`);
        const baseUrl = requestParameters.base_url;
        console.log(`128. Request Base URL To Get: ${baseUrl}`);
...
// Iniciar el servidor
app.listen(port, () => {
    console.log(`188. Servidor corriendo en el puerto ${port}`);
});
